...
export const export_csv_bundle: (a: number, b: number) => [number, number, number, number];
export const export_filename: (a: number, b: number) => [number, number, number, number];
export const export_html: (a: number, b: number) => [number, number, number, number];
export const export_json: (a: number, b: number) => [number, number, number, number];
export const export_mermaid: (a: number, b: number) => [number, number, number, number];
export const export_to_duckdb_sql: (a: number, b: number) => [number, number, number, number];
export const export_xlsx: (a: number, b: number) => [number, number, number, number];
