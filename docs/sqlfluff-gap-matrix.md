...
| Convention | `convention.not_equal` | `CV01` | No | Yes | Implemented (partial) | `LINT_CV_001` | No | Heuristic parity rule implemented in `crates/flowscope-core/src/linter/rules/parity.rs`; semantics are narrower than SQLFluff. |
...
| Convention | `convention.statement_brackets` | `CV07` | No | Yes | Implemented (partial) | `LINT_CV_007` | No | Heuristic parity rule implemented in `crates/flowscope-core/src/linter/rules/parity.rs`; semantics are narrower than SQLFluff. |
