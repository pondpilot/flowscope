...
- [x] `LINT_CV_001`, `LINT_CV_007`, and `LINT_CV_009`-`LINT_CV_011` are now split out of `parity.rs` into dedicated core modules (`cv_001.rs`, `cv_007.rs`, `cv_009.rs`-`cv_011.rs`); `LINT_CV_007`, `LINT_CV_009`, and `LINT_CV_010` are now AST-driven, while `LINT_CV_001`/`LINT_CV_011` currently preserve heuristic behavior.
