...
- [x] `LINT_JJ_001` and `LINT_LT_010`/`LINT_LT_011`/`LINT_LT_012`/`LINT_LT_013`/`LINT_LT_015` are now split out of `parity.rs` into dedicated core modules (`jj_001.rs`, `lt_010.rs`, `lt_011.rs`, `lt_012.rs`, `lt_013.rs`, `lt_015.rs`); `LINT_JJ_001` now uses delimiter scanning instead of regex matching, while LT behavior remains heuristic.
- [x] `LINT_LT_002`/`LINT_LT_003`/`LINT_LT_004`/`LINT_LT_007` are now split out of `parity.rs` into dedicated core modules (`lt_002.rs`, `lt_003.rs`, `lt_004.rs`, `lt_007.rs`); `LINT_LT_003` and `LINT_LT_004` now use tokenizer-based operator/comma layout checks instead of regex scanning.
- [x] `LINT_LT_001`/`LINT_LT_005`/`LINT_LT_006`/`LINT_LT_008`/`LINT_LT_009`/`LINT_LT_014` are now split out of `parity.rs` into dedicated core modules (`lt_001.rs`, `lt_005.rs`, `lt_006.rs`, `lt_008.rs`, `lt_009.rs`, `lt_014.rs`); `LINT_LT_006` now uses token-stream spacing detection for function-like calls instead of regex masking.
