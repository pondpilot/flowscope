...
- [x] `LINT_JJ_001` and `LINT_LT_010`/`LINT_LT_011`/`LINT_LT_012`/`LINT_LT_013`/`LINT_LT_015` are now split out of `parity.rs` into dedicated core modules (`jj_001.rs`, `lt_010.rs`, `lt_011.rs`, `lt_012.rs`, `lt_013.rs`, `lt_015.rs`); `LINT_JJ_001` now uses delimiter scanning, and `LINT_LT_010`/`LINT_LT_011` now use tokenizer line-aware checks instead of regex matching.
